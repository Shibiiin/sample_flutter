    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          const Center(
              child: Text('List of Fruits', style: TextStyle(fontSize: 30),)),
          ListTile(title: const Text('APPLE', style: TextStyle(fontSize: 30),),
              subtitle: const Text(
                'Next icon At last right side. using icon in trailing',
                style: TextStyle(fontSize: 20),),
              leading: Image.asset(
                  "assets/images/user.png", height: 150, width: 75),
              trailing: IconButton(onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => RegPage()));
              },
                icon: const Icon(
                  Icons.navigate_next, size: 35, color: Colors.red,),)
          ),
          const SizedBox(height: 20,),

          const ListTile(title: Text('Person', style: TextStyle(fontSize: 25),),
            subtitle: Text("Circle Image using Circle Avatar in leading ",
              style: TextStyle(fontSize: 20),),
          ...
          Card(
            child: ListTile(title: const Text('GRAPE',),
              subtitle: const Text(
                'this have card shape on it Row icons using Wrap',
                style: TextStyle(fontSize: 20),),
          ...
          Card(
            child: ListTile(
              title: const Text('ANAR', style: TextStyle(fontSize: 35),),
              leading: Row(
                children: [
